...
<body>
	<!--
		서블릿 작성순서
		1. 서블릿을 호출 하기 위한 요청명을 제일 먼저 결정한다.
		아래 경로는 상대 경로이므로 컨텍스트 루트를 신경 쓸 필요가 없다.
		
		2. web.xml 에서 서블릿 매핑을 진행한다.
		
		3. 요청을 처리 할 서블릿을 제작한다.
