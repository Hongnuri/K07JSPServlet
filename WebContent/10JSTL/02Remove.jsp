...
<body>
	<!-- 
		remove 태그 : set 으로 선언한 변수를 제거할 때 , 사용하는 태그 영역에 저장 된 속성을 제거하므로
		로그아웃에서 사용할 수도 있다.
	-->
	<h2>remove 태그</h2>
	...
	<!-- 
		xxScope 내장 객체를 사용하지 않으면 가장 좁은 영역의 변수를 읽어온다.
	...
	<!-- 
		영역에 동일한 이름의 속성이 존재하는 경우에는 모든 영역의 속성이 한 꺼번에 삭제되므로 사용에 주의해야한다.
	-->
	<h3>remove 로 삭제하기</h3>
	...
	<!--  
		속성명은 존재하지만 영역 설정이 잘못 된 경우 아무 것도 삭제 되지 않는다.
