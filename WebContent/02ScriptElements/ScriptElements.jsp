...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
	선언부(Declaration) : 스크립트렛이나 표현식에서 사용 할 메소드를 선언 할 때 , 사용한다.
...
<body>
	<h2>JSP 의 스크립트 요소들 (Scripting Elements)</h2>
	<%@ include file = "../01Directive/IncludePage.jsp" %>
	<%--
	스트립트릿(Scriptlet) : 주로 JSP 코드를 작성하고 실행할 때 , 사용하는 영역이다.
	스트립트릿은 head 영역 , body 영역 어디서든 사용할 수 있다. 
	...
	표현식(Expression) : 변수를 웹브라우저상에 출력할 때 , 사용한다.
		JS 의 document.write() 와 동일한 역할을 한다.
		표현식 사용시 주의할 점은 문장 끝에 ;(세미콜론) 을 생략해야하는 것이다.
	--%>
